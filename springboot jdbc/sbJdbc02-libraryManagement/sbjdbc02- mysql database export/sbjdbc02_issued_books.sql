...
CREATE TABLE `issued_books` (
  ...
  `expected_submit_date` date DEFAULT NULL,
  `actual_submit_date` date DEFAULT NULL,
  `issue_days` int DEFAULT NULL,
  ...
  CONSTRAINT `issued_books_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `issued_books` VALUES (1,10,2,'2025-05-28','2025-06-12','2025-06-12',15,41.25,0,0);
